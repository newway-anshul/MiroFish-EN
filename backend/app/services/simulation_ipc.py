...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Target platform (optional)
                ...
                - None: use both platforms in dual-platform simulation, or the single active platform in single-platform simulation
            timeout: Timeout

        Returns:
            IPCResponse, where `result` contains interview output
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
    ...
    def send_batch_interview(
        ...
        Args:
            interviews: Interview list, each item includes {"agent_id": int, "prompt": str, "platform": str (optional)}
        ...
        Returns:
            IPCResponse, where `result` contains all interview outputs
        """
    ...
    def send_close_env(self, timeout: float = 30.0) -> IPCResponse:
        """
        Send environment close command.
    ...
    def check_env_alive(self) -> bool:
        """
        Check whether simulation environment is alive.

        Determined by reading `env_status.json`.
        """
